...
def LatLon_TO_index(lat, lon):
    ...
    # sabiengo el numeroo de filas y columnas q se cubren y los puntos maximos y minimos, 
    # dividimos la matriz original en grados para adjudicar a cada punto una lat,long
